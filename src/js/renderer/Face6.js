...
class Face6 extends Face {
    constructor(
        ...
        this.interleavedArray.push(
            ...
            ...e, ...this.normal, ...center, ...color, displacementY, startPositions[4][0], startPositions[4][1], startPositions[4][2],
            ...f, ...this.normal, ...center, ...color, displacementY, startPositions[5][0], startPositions[5][1], startPositions[5][2])
    }
}
